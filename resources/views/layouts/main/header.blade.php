            ...
            <ul class="list-js links-list">
                <li class="menu-item has-sub-menu"><a class="menu-link   active" href="#0">Про нас <i class="fas fa-plus  plus-icon"> </i></a>
                    <ul class="sub-menu ">
                        ...
                        <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="#">Нормативно-правова база</a></li>
                ...
                <li class="menu-item has-sub-menu"><a class="menu-link  " href="#0">Напрямки роботи<i class="fas fa-plus  plus-icon"> </i></a>
                    <ul class="sub-menu ">
                        ...
                        <li class="menu-item sub-menu-item"><a class="menu-link sub-menu-link  " href="#">Олімпіади</a></li>
                    </ul>
                </li>
