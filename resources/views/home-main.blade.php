        ...
        <div class="row align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <h1 class="hero-title  ">Центр професійного
                                <span class="featured-text">розвитку <svg xmlns="http://www.w3.org/2000/svg"
                                                                          class="wavey-underline" width="1104.664"
                                                                          height="100.188"
                                                                          viewBox="0 0 1104.664 100.188">  <path
                                            id="Path_208" data-name="Path 208"
                                            ...
                                            transform="translate(-504.796 -1565.664)" fill="none" stroke="#030303"
                                            stroke-width="5"/></svg>  </span><span
                                    class="design-element rounded-shape stripes"></span>
                                педагогічних працівників
                            </h1>
                            <div class="pre-title ">Вишневої міської ради</div>
                        </div>
                        <!--                <div class="col-10       ">-->
            ...
            <div class="col-12   mx-md-auto col-lg-6 text-center " data-tilt>
                <div class="hero-image-area mb-5 mb-lg-0">
                    <div class="hero-img-wraper  "><img class="img-fluid " src="assets/images/hero/illustration-4.png"
...
<section class="blog blog-home mega-section  " id="blog">
    <div class="container ">
        <div class="sec-heading  ">
            <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Новини</span>
                <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Останні новини<span class='hollow-text'></span>
                </h2>
            </div>
            <div class=" cta-area  cta-area  wow fadeInUp" data-wow-delay=".8s"><a
                    class="cta-btn btn-solid   cta-btn btn-solid  " href="{{ route('news') }}">Переглянути всі<i
                    ...
                    <div class="row">
                        @foreach($news as $item)
                            <div class="col-12 col-lg-4 ">
                                <div class="post-box"><a class="post-link" href="{{ route('simple_news', $item->id) }}"
                                                         title="{{ $item->title }}">
                                        <div class="post-img-wrapper  "><img class=" parallax-img   post-img"
                                                                             loading="lazy"
                                                                             src="{{ $item->preview_image }}"
                                                                             alt=""/><span class="post-date">
                                                <span
                                    ...
                                    <div class="post-summary">
                                        ...
                                        <div class="post-text"><a class="post-link" target="_blank"
...
<section class="about mega-section" id="about">
    <div class="container">
        ...
        <div class="content-block  ">
            <div class="row">
                <div
                    class="col-12 col-lg-12 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp "
                    data-wow-delay="0.6s">
                    <div class="text-area ">
                        <div class="sec-heading  light-title ">
                            <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Напрямки роботи</span>
                                <h2 class=" title    wow fadeInUp" data-wow-delay=".4s"><span class='hollow-text'>Ми команда, що націлена</span>
                                    на <span class='featured-text'>  розвиток <svg xmlns="http://www.w3.org/2000/svg"
                                                                                   viewBox="0 0 500 150"
                                                                                   preserveAspectRatio="none"><path
                                                d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path></svg></span>
                                </h2>
                            </div>
                        </div>
                        <p class=" about-text">Сучасний світ потребує нового підходу до професійного розвитку
        ...
        <!--End first about div-->
        <!--        &lt;!&ndash; Start first about div&ndash;&gt;-->
        <!--        <div class="content-block  ">-->
        <!--          <div class="row">-->
        ...
        <!--          </div>-->
        <!--        </div>-->
        <!--        &lt;!&ndash;End first about div&ndash;&gt;-->
    </div>
</section>
<!-- End  about Section-->
