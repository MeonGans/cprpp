    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-10 mx-auto">
                ...
                <div class="post-img-wrapper post-featured-area"><img class="featured-img" loading="lazy" src="{{ $news->preview_image }}" alt="Main Image"></div>
            </div>
            <div class="col-12 col-lg-9 mx-auto">
                <div class="post-main-area">
                    <div class="post-info"><a class="info post-author" href="#"><i class="fas fa-user icon"></i>Світлана Сушко</a><a class="info post-date" href="#"><i class="fas fa-history icon"></i>{{ date_format($news->date, 'd.m.Y')  }}</a><a class="info post-time" href="#"><i class="fas fa-eye icon"></i>1975</a></div>
